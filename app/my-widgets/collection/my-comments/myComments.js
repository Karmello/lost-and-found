angular.module('appModule').directive('myComments', function(
  $rootScope, $timeout, $moment, myCommentsService, CommentsRest, MyForm, MyFormModel
) {
  return {
    restrict: 'E',
    ...
    controller: function($scope) {
      ...
      $scope.myForm = new MyForm({
        ...
        model: new MyFormModel({ userId: {}, content: {} }),
